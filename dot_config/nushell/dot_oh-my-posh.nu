...
$env.POSH_THEME = (echo "F:\\ProgramData\\scoop\\persist\\nushell\\atomic.omp.json")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = (echo "e4e5426f-3c2d-432a-9479-05d6774f5223")
$env.POSH_SHELL = "nu"
...
let _omp_executable: string = (echo "F:/ProgramData/scoop/apps/oh-my-posh/current/oh-my-posh.exe")
